...
<h2 style="text-align:center;">Q&A 게시글 작성</h2>
<hr>
...
<table class="table">
	...
	<tr>
		...
		<td><textarea name="qContent" class="form-control" style="height:414px;"></textarea></td>
	</tr>
	<tr>
		<td colspan="2">
			<input type="checkbox" name="qSetting" id="setting" value="1">  비밀글설정
		</td>
	</tr>
	<tr>
		<td style="width:166px;">비밀번호</td>
		<td><input type="password" name="qPwd" id="pwd" class="form-control"></td>
	</tr>
	<tr>
		<td colspan="2">
