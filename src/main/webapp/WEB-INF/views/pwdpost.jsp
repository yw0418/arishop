...
<div class="container">
<center>
<h2 style="margin-top:250px; margin-bottom:30px;">비밀글입니다.</h2>
<h5>비밀번호를 입력해주세요</h5>
<br>
	<form action="secretpost" method="post">
		<input type="hidden" name="qnaNo" value=${qdto.qnaNo }>
		<input type="hidden" name="qOnum" value=${qdto.qOnum }>
		<input type="password" name="qPwd" style="height:33px;">
