...
function checkData(){
   ...
   if(frm.sangDetail.value===""){
	      alert("상세정보를 입력하세요");
	      frm.sangDetail.focus();
	      return;
	}
   
   if(frm.sangNumber.value===""){
	      alert("상품재고를 입력하세요");
	      frm.sangNumber.focus();
	      return;
	}
...
<h2 style="text-align:center;">상품추가 페이지</h2>
<hr>

<div class="container" style="padding-left:60px; padding-right:60px">
<form action="insertSang" method="post"  name="frm" enctype="multipart/form-data">
<table class="table">
	<tr>
		<td style="width:166px;">상품이름</td>
		<td><input type="text" name="sangName" class="form-control"></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td><textarea name="sangDetail" class="form-control" style="height:304px;"></textarea></td>
	</tr>
	<tr>
		<td style="width:166px;">상품재고</td>
		<td><input type="text" name="sangNumber" class="form-control"></td>
	</tr>
	<tr>
		<td style="width:166px;">상품이미지</td>
		<td><input type="file" name="file"></td>
	</tr>
	<tr>
		<td colspan="2">
			<input type="submit" id="btnSubmit" value="등록" class="btn btn-success">
		</td>
	</tr>
</table>
</form>
